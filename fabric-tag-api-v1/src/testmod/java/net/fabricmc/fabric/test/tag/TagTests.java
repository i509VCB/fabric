...
public class TagTests implements ModInitializer {
	...
	public static final Tag.Identified<Block> FALLING = TagRegistry.block(new Identifier("testmod", "falling"));
	...
	public void onInitialize() {
		...
		ServerStartCallback.EVENT.register(this::testFallingTag);
		ServerStartCallback.EVENT.register(this::testBossTag);
	}
